...
public class SettingsActivity extends PreferenceActivity {
    ...
    @Override public Intent onBuildStartFragmentIntent(String name, Bundle args, int titleRes,
            int titleShortRes) {
        final Intent i = super.onBuildStartFragmentIntent(name, args, titleRes, titleShortRes);
        if ((DataUsageSummary.class.getName().equals(name))
                || (PowerUsageSummary.class.getName().equals(name))
                || (AccountSyncSettings.class.getName().equals(name))
                || (UserDictionarySettings.class.getName().equals(name))
                || (Memory.class.getName().equals(name))
                || (ManageApplications.class.getName().equals(name))
                || (WirelessSettings.class.getName().equals(name))
                || (SoundSettings.class.getName().equals(name))
                || (PrivacySettings.class.getName().equals(name))
                || (com.android.settings.cyanogenmod.PrivacySettings.class.getName().equals(name))
                || (ManageAccountsSettings.class.getName().equals(name))) {
            i.putExtra("settings:remove_ui_options", true);
        }
        i.setClass(this, SubSettings.class);
        return i;
    }

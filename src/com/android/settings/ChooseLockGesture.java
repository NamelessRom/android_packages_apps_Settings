...
public class ChooseLockGesture extends SettingsActivity {
    ...
    protected boolean isValidFragment(String fragmentName) {
        return ChooseLockGestureFragment.class.getName().equals(fragmentName);
    }

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        CharSequence msg = getText(com.android.internal.R.string.kg_gesture_instructions);
        setTitle(msg);
    }

    public static class ChooseLockGestureFragment extends Fragment implements View.OnClickListener {
        ...
        private static final int MIN_PREDICTION_SCORE = 2;
        ...
        protected enum Stage {
            ...
            Introduction(
                    com.android.internal.R.string.kg_gesture_instructions,
